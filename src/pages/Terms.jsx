...
const Terms = () => (
  <div className="max-w-4xl mx-auto px-4 sm:px-6 py-16 text-gray-800">
    ...
    <div className="space-y-6 text-base leading-7">
      <p>
        By accessing or using any service provided by <strong>GiiTech Software Systems</strong>, you
      ...
      <p>
        ...
        error-free or continuously available. GiiTech is not liable for any indirect damages resulting
      ...
      <p>
        ...
        GiiTech unless otherwise stated. Unauthorized reproduction or redistribution is strictly
        prohibited.
      </p>
      <p>
