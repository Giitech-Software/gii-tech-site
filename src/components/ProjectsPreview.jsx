 ...
 useEffect(() => {
    const fetchProjects = async () => {
      ...
      const projectData = snap.docs
        ...
        .filter(p => 
          // 1. Must have a title that isn't just whitespace
          p.title && p.title.trim() !== "" && 
          // 2. Must have a description that isn't just whitespace
    ...
    <>
      ...
      <div className="min-h-screen bg-white text-slate-900 px-6 lg:px-16 py-12">
        <div className="max-w-7xl mx-auto">
          ...
          {/* This conditional now correctly checks the filtered list */}
          {projects.length === 0 ? (
      ...
      {/* FULL-WIDTH PROJECT MODAL OVERLAY */}
      {activeProject && (
